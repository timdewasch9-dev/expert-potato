...
window.PROJECTS = [
  {
    ...
    cover: "assets/img/mise-en-space-7.jpg",
    description: [
    ...
    images: [
      { src: "assets/img/mise-en-space-cover.jpg", title: "Concept sketch", main: true },
      { src: "assets/img/mise-en-space-1.jpg", title: "Threshold sequence sketch" },
      { src: "assets/img/mise-en-space-2.jpg", title: "Body orientation diagram" },
      { src: "assets/img/mise-en-space-3.jpg", title: "Sensory choreography diagram" },
      { src: "assets/img/mise-en-space-4.jpg", title: "Object family, tasting" },
      { src: "assets/img/mise-en-space-6.jpg", title: "Coffee-wax candle" },
      { src: "assets/img/mise-en-space-5.jpg", title: "Material study" },
    ],
  },
  {
    slug: "soft-parasite",
    ...
    cover: "assets/img/soft-parasite-6.jpg",
    description: [
    ...
    images: [
      ...
      { src: "assets/img/soft-parasite-cover.jpg", title: "Exploded axonometric" },
      { src: "assets/img/soft-parasite-7.jpg", title: "Corridor concept sketch" },
      { src: "assets/img/soft-parasite-1.jpg", title: "Interior axonometric" },
      { src: "assets/img/soft-parasite-2.jpg", title: "Box-in-box axonometric" },
      { src: "assets/img/soft-parasite-3.jpg", title: "Plan diagram" },
  ...
  },
  {
    ...
    images: [
      { src: "assets/img/resonant-growth-6.jpg", title: "Alley render, dusk", main: true },
      { src: "assets/img/resonant-growth-cover.jpg", title: "Installed acoustic panel" },
      { src: "assets/img/resonant-growth-3.jpg", title: "Clay print process" },
      { src: "assets/img/resonant-growth-2.jpg", title: "Material layer render" },
      { src: "assets/img/resonant-growth-5.jpg", title: "Moss growth detail" },
      { src: "assets/img/resonant-growth-1.jpg", title: "Site model" },
      { src: "assets/img/resonant-growth-4.jpg", title: "Elevation diagram" },
      { src: "assets/img/resonant-growth-7.jpg", title: "Panel applied indoors" },
    ],
  },
  {
    slug: "raw-25",
    ...
    images: [
      { src: "assets/img/raw-25-cover.jpg", title: "Masterplan, four zones", main: true },
  ...
  },
  {
    ...
    images: [
      { src: "assets/img/reculture-2.jpg", title: "Modular interventions", main: true },
  ...
  },
  {
    ...
    images: [
      { src: "assets/img/through-the-wall-4.jpg", title: "Masterplan, four zones", main: true },
      { src: "assets/img/through-the-wall-3.jpg", title: "Brick tower, structural axonometric" },
      { src: "assets/img/through-the-wall-1.jpg", title: "Landscape silhouette sketch" },
      { src: "assets/img/through-the-wall-2.jpg", title: "Site silhouette study" },
    ],
  },
];
